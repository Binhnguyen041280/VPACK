...
def update_database():
    ...
    try:
        with safe_db_connection() as conn:
            ...
            print("🛍️ Creating Shopee Calculator tables...")

            # 20. Shopee Fee Configs Table
            cursor.execute("""
            ...
            cursor.execute("""
                CREATE TABLE IF NOT EXISTS shopee_calculations (
                    ...
                    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                    FOREIGN KEY (user_email) REFERENCES user_profiles(gmail_address) ON DELETE CASCADE,
                    FOREIGN KEY (parent_calc_id) REFERENCES shopee_calculations(calc_id) ON DELETE SET NULL
                )
            """)

            # 23. Shopee Custom Cost Presets Table
            cursor.execute("""
            ...
            # 24. Shopee Calculation History Table
            cursor.execute("""
            ...
            print("✅ Shopee Calculator tables created successfully")
