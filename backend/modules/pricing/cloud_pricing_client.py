...
class CloudPricingClient:
    ...
    def __init__(self):
        # CloudFunction URL
        self.pricing_url = os.getenv('PRICING_SERVICE_URL', 
    ...
    def fetch_pricing_on_startup(self) -> Dict[str, Any]:
        ...
        try:
            response = requests.get(
                ...
                timeout=10,
                headers={
                    'User-Agent': 'VTrack-Desktop/2.1.0',
            ...
            if response.status_code == 200:
                ...
                if data.get('success'):
                    ...
                    logger.info(f"✅ Startup pricing loaded: {packages_count} packages, version {version}")
                    return data
                else:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if data.get('success'):
                    ...
                    logger.info(f"✅ Fresh pricing loaded: {packages_count} packages, version {version}")
    ...
    def test_connection(self) -> Dict[str, Any]:
        ...
        try:
            response = requests.get(
                f"{self.pricing_url}?action=health",
                timeout=5
            )
