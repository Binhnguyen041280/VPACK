...
class Step4PackingAreaService:
        ...
        try:
            ...
            with safe_connection_wrapper() as conn:
                ...
                for zone in detection_zones:
                    ...
                    cursor.execute(
                        "SELECT 1 FROM packing_profiles WHERE profile_name = ?", (camera_name,)
                    )
                    ...
                    if exists:
                        ...
                        cursor.execute(
                            ...
                            WHERE profile_name = ?
                        """,
                            (json.dumps(trigger_area), json.dumps(packing_area), camera_name),
                        )
                    else:
    ...
    def get_camera_packing_profile(self, camera_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"camera_name": camera_name, "error": str(e), "exists": False}

    def call_existing_roi_selection(
        self, video_path: str, camera_id: str, step: str = "packing"
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            log_step_operation(
                "4",
                "roi_selection",
                {"camera_id": camera_id, "step": step, "success": result.get("success", False)},
            )
    ...
    def call_existing_roi_finalization(
        self, video_path: str, camera_id: str, rois: List[Dict]
    ) -> Dict[str, Any]:
        """
    ...
    def get_all_cameras_roi_status(self) -> Dict[str, Any]:
        ...
        try:
            with safe_connection_wrapper() as conn:
                ...
                log_step_operation(
                    "4",
                    "get_all_cameras_roi_status",
                    {"total": result["total"], "configured": result["configured"]},
                )
            ...
            return {"cameras": [], "total": 0, "configured": 0, "error": str(e)}
