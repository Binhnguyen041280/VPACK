...
class Step3VideoSourceService:
    ...
    def get_video_source_config(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if active_source:
                ...
                config = (
                    active_source.get("config", {})
                    if isinstance(active_source.get("config"), dict)
                    else {}
                )
    ...
    def update_video_source_config(self, data: Dict[str, Any]) -> Tuple[bool, Dict[str, Any]]:
        ...
        try:
            ...
            actual_selected_cameras, camera_paths, actual_input_path = (
            ...
            sync_success = self._sync_to_processing_config(
                actual_input_path, actual_selected_cameras, camera_paths
            )
            if not sync_success:
        ...
        try:
            with safe_connection_wrapper() as conn:
                ...
                if row:
                    ...
                    selected_cameras = (
                        json.loads(selected_cameras_json) if selected_cameras_json else []
                    )
    ...
    def _map_source_type(self, source_type: str) -> str:
        ...
        type_mapping = {"local_storage": "local", "cloud_storage": "cloud"}
    ...
    def _sync_to_processing_config(
        self, input_path: str, selected_cameras: List[str], camera_paths: Dict[str, str]
    ) -> bool:
        """
