...
def handle_database_error(error: Exception, operation: str = "database operation") -> Tuple[Dict[str, Any], int]:
    """
...
def handle_validation_error(error_message: str, field: str = "", step_name: str = "") -> Tuple[Dict[str, Any], int]:
    """
...
def handle_general_error(error: Exception, operation: str = "operation", step_name: str = "") -> Tuple[Dict[str, Any], int]:
    """
...
def handle_compatibility_error(error: Exception, fallback_data: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    """
    ...
    error_info = {
        ...
        "error_type": "backward_compatibility"
    }
...
def log_step_operation(step_name: str, operation: str, data: Optional[Dict[str, Any]] = None, success: bool = True):
    """
...
def create_success_response(data: Dict[str, Any], message: str = "", changed: bool = True) -> Dict[str, Any]:
    """
