...
def get_step_brandname():
    ...
    try:
        ...
        if "error" in result:
            ...
            response_data = {"brand_name": result["brand_name"]}
...
def update_step_brandname():
    ...
    try:
        ...
        response_data = {"brand_name": result["brand_name"], "changed": result["changed"]}
    ...
    try:
        ...
        if is_valid:
            response = {
                ...
                "data": {"brand_name": brand_name, "character_count": len(brand_name)},
            }
            status_code = 200
        else:
            response = {
