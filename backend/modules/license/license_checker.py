...
class LicenseChecker:
    ...
    def _check_expiry_warning(
        self, license_data: Optional[Dict[str, Any]]
    ...
    def _check_internet_connectivity(self) -> bool:
        ...
        try:
            ...
            now = datetime.now()
            if (
                self._connection_cache["last_check"]
                and self._connection_cache["online"] is not None
            ):
    ...
    def force_online_validation(self, license_key: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": str(e), "network_status": "error"}
