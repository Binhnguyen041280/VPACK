...
class LicenseManager:
        ...
        if self._repository is None:
            try:
                ...
                try:
                    ...
                    from backend.modules.licensing.repositories.license_repository import (
    ...
    def get_local_license(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if license_data:
                logger.info(
                    f"Found local license: {license_data.get('license_key', 'N/A')[:20]}..."
                )
    ...
    def get_license_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if not local_license:
                ...
                return {"status": "no_license", "has_license": False, "message": "No license found"}
            ...
            return {"status": "error", "has_license": False, "error": str(e)}
    ...
    def get_machine_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"machine_fingerprint": "unknown", "error": str(e)}
