...
# ✅ NEW: Global OPTIONS handler for all routes in this blueprint
...
def finalize_roi_endpoint():
    try:
        # ✅ FIXED: Only parse JSON for POST requests (OPTIONS already handled by before_request)
...
def get_roi_frame():
    # ✅ OPTIONS already handled by before_request
